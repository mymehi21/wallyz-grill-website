...
import { UtensilsCrossed, Truck, Plus, Minus, ShoppingBag, Trash2, Edit, X } from 'lucide-react';
...
export default function Catering() {
  ...
  const validateMenuOrder = async () => {
    ...
    if (getTotalTrayQuantity() === 0) {
      alert('Please select at least one party tray.');
      return false;
    }
  ...
  const handleTruckRequestSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Send email notification to restaurant owner and customer
      try {
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              >
                <UtensilsCrossed className="text-orange-500 mb-4 mx-auto" size={64} />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="text-center mb-8">
              <UtensilsCrossed className="text-orange-500 mb-4 mx-auto" size={64} />
              <h1 className="text-4xl font-bold mb-4">Party Trays Order</h1>
            ...
            <div className="bg-gray-800 rounded-lg p-8 border-2 border-orange-500 mb-8">
              <div className="flex justify-between items-center mb-6">
                <div>
                  <h3 className="text-3xl font-bold text-white mb-2">Select Party Trays</h3>
              ...
              {getTotalTrayQuantity() === 0 && (
                <div className="bg-red-900 bg-opacity-30 border border-red-500 rounded-lg p-4 mb-4">
                  <p className="text-red-400 text-center font-semibold">
                    Please select at least one party tray to continue
                  </p>
                </div>
              )}
              ...
              <button
                ...
                onClick={() => {
                  if (getTotalTrayQuantity() === 0) {
                    alert('Please select at least one party tray before adding menu items.');
                    return;
                  }
              ...
              {getTotalTrayQuantity() === 0 && (
                <p className="text-sm text-gray-400 text-center mt-2">
                  Select a party tray first to add menu items
                </p>
              )}
            </div>
            ...
            {(getTotalTrayQuantity() > 0 || getTotalRegularQuantity() > 0) && (
              <div className="bg-gray-800 rounded-lg p-6 border-2 border-orange-500 mb-8">
                ...
                {getTotalTrayQuantity() > 0 && (
                  <div className="mb-4">
                    <h4 className="text-lg font-semibold text-orange-500 mb-2">Party Trays</h4>
                    {partyTrays.map(tray => {
                      const qty = trayQuantities[tray.id] || 0;
            ...
            <div className="bg-gray-800 rounded-lg p-8 border border-orange-500">
              <form onSubmit={handleMenuOrderSubmit} className="space-y-6">
                ...
                >
                  {submitting ? 'Submitting Order...' : getTotalTrayQuantity() === 0 ? 'Select Party Trays to Continue' : `Submit Order ($${calculateTotalAmount().toFixed(2)})`}
                </button>

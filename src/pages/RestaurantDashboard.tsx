...
export default function RestaurantDashboard({ account, onLogout }: RestaurantDashboardProps) {
  ...
  // Better alert sound — restaurant-style chime
  const playAlertSound = useCallback(() => {
    try {
      ...
      // 3-tone restaurant chime: C5 - E5 - G5 - E5 - C5
      playNote(523, 0.0, 0.4, 0.6);
      playNote(659, 0.3, 0.4, 0.6);
      playNote(784, 0.6, 0.5, 0.7);
      playNote(659, 1.0, 0.3, 0.5);
      playNote(523, 1.3, 0.6, 0.6);
    } catch (e) {

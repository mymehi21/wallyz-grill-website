...
function AdminRoute() {
  ...
  // Restaurant session — stored in sessionStorage so it survives page refresh on iPad
  ...
  // Restaurant session active — show restaurant dashboard
  ...
  // Not authenticated as admin — show unified login
  if (!isAuthenticated) {
    return (
      <AdminLogin

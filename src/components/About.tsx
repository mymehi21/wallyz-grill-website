    ...
    <section id="about" className="py-20 bg-black text-white">
      ...
      <div className="relative h-64 md:h-80 mb-16 overflow-hidden">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <Logo size={100} className="mb-4 drop-shadow-2xl" />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20 items-center">
            <div className="relative rounded-2xl overflow-hidden shadow-2xl h-96">
              ...
              <div className="absolute bottom-4 left-4">
                <span className="bg-orange-500 text-white text-sm font-bold px-3 py-1 rounded-full">Est. 2020</span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mb-20">
            {[
              ...
              { icon: Award, title: 'Quality First', desc: 'Award-winning flavors that keep our customers coming back for more.' },
              { icon: Users, title: 'Community Driven', desc: 'Proud to serve the Oak Park and Redford communities.' },
              { icon: Clock, title: 'Always Fresh', desc: 'Open daily with fresh prep every morning. Never reheated leftovers.' },
              { icon: MapPin, title: 'Two Locations', desc: 'Convenient locations in Oak Park and Redford, Michigan.' },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div key={loc.name} className="bg-gray-900 rounded-2xl p-6 border border-gray-800 hover:border-orange-500/50 transition-all group">

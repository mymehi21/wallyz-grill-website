  ...
  return (
    <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <div className="space-y-2">
                        {(item.customization_options?.protein_additions || []).map((addon: any, idx: number) => (
                          <div key={idx} className="flex items-center gap-2">
                            <input
                              ...
                              onChange={(e) => {
                                const addons = [...(item.customization_options?.protein_additions || [])];
                                addons[idx] = { ...addons[idx], name: e.target.value };
                                const updated = menuItems.map(i =>
                                  i.id === item.id ? { ...i, customization_options: { ...i.customization_options, protein_additions: addons } } : i
                                );
                                setMenuItems(updated);
                              }}
                              className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 text-gray-900 text-sm"
                            />
                            ...
                            <input
                              ...
                              className="w-24 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 text-gray-900 text-sm"
                            />
                            <button
                              type="button"
                              onClick={() => {
                                const addons = (item.customization_options?.protein_additions || []).filter((_: any, i: number) => i !== idx);
                                const updated = menuItems.map(i =>
                                  i.id === item.id ? { ...i, customization_options: { ...i.customization_options, protein_additions: addons } } : i
                                );
                                setMenuItems(updated);
                        ...
                        <button
                          type="button"
                          onClick={() => {
                            const addons = [...(item.customization_options?.protein_additions || []), { name: '', price: 0 }];
                            const updated = menuItems.map(i =>
                              i.id === item.id ? { ...i, customization_options: { ...i.customization_options, protein_additions: addons } } : i
                            );
                            setMenuItems(updated);
                          }}
                          className="flex items-center gap-2 px-3 py-2 text-orange-600 border border-orange-300 rounded-lg hover:bg-orange-50 text-sm font-medium"
                        >
      ...
      {menuType === 'catering' && cateringItems.length === 0 && (
        <div className="text-center py-12">
          <p className="text-gray-500">No party trays yet. Click "Add Item" to create your first one.</p>
        </div>
      )}
